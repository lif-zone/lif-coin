...
//lifmain.magic = 0x0eca929b; // LIF(10 things).LE32()
lifmain.magic = 0x0eca9201; // LIF(10 things).LE32() 01 test
...
lifmain.genesis = {
  ...
  merkleRoot:
    b('3ba3edfd7a7b12b27ac72c3e67768f617fc81bc3888a51323a9fb8aa4b1e5e4a'),
  time: 1231006505, // mined
  //bits: 0x1e00ffff, nonce: 5610075, // 10 seconds
  //hash: b('b3e89cc50a3910f32010067b39979356a679ec687269228782e1e253ea000000'),
  //bits: 0x1d00ffff, // final
  bits: 0x1f00ffff, // fast
  nonce: 29664, // mined
  hash: b('db622c5c3811f640a46e4f36e2d60380c37167d5b636389dffca75195e700000'),
  height: 0
};
...
liftest.keyPrefix = { // XXX: chose as testnet
  privkey: 0xef,
  xpubkey: 0x043587cf,
  xprivkey: 0x04358394,
  xpubkey58: 'tpub',
